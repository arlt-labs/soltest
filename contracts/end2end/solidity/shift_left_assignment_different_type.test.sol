import 'shift_left_assignment_different_type.sol';
import 'Soltest.sol'; // this file will be virtually provided by the testing environment - it's not existing physically.

contract shift_left_assignment_different_type_Test is Soltest { 
    function test_shift_left_assignment_different_type() { 
