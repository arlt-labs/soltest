import 'struct_containing_bytes_copy_and_delete.sol';
import 'Soltest.sol'; // this file will be virtually provided by the testing environment - it's not existing physically.

contract struct_containing_bytes_copy_and_delete_Test is Soltest { 
    function test_struct_containing_bytes_copy_and_delete() { 
