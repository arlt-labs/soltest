import 'events_with_same_name_inherited_emit.sol';
import 'Soltest.sol'; // this file will be virtually provided by the testing environment - it's not existing physically.

contract events_with_same_name_inherited_emit_Test is Soltest { 
    function test_events_with_same_name_inherited_emit() { 
