...
#ifndef SOLTEST_CONTRACT_H
#define SOLTEST_CONTRACT_H

#include <boost/variant.hpp>

#include <libdevcore/Common.h>

#include <libsoltesting/interpreter/executor/IExecutor.h>
...
class Contract: public Address, public Executable
{
